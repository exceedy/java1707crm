 ...
 $(function () {
	...
	//分配的弹出框
 	 function openUpdateDialog() {
		 ...
		 $("#dialog").dialog("open").dialog("setTitle","分配客服服务");
...
<body>
	...
	<div id="dialog" modal="true" style="width:650;height:280,padding: 10px 20px">
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
		   		...
		   		<tr>
		   			<td>指派给：</td>
		   			<td><input class="easyui-combobox" id="assigner" name="assigner" data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/getCustomerManagerList.action'"/></td>
		   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   			<td>指派时间：</td>
	...
	<!-- 添加和修改的dialog 结束 -->
		 <div id="toolbar">
		 	<div>
				 <a href="javascript:openUpdateDialog()" class="easyui-linkbutton" iconCls="icon-fwfp" >分配</a>
			</div>
		 </div>
</body>
</html>