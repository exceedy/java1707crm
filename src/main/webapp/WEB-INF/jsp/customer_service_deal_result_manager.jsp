...
<body>
		...
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
		   		...
		   		<tr>
			   			...
			   			<td>处理结果：</td>
			   			<td><input type="text" id="serviceDealResult" name="serviceDealResult"  />&nbsp;<font color="red">*</font></td>
			   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<!-- 添加和修改的dialog 结束 -->
		 <div id="toolbar">
		 	<div>
				 <a href="javascript:openUpdateDialog()" class="easyui-linkbutton" iconCls="icon-fwfk" >客户服务反馈</a>
			</div>
		 </div>
</body>
</html>